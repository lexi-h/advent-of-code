...
std::string lose_to(const std::string p1throw);
std::string win_to(const std::string p1throw);
...
std::string lose_to(const std::string p1throw){
    if (p1throw == "rock") return std::string("scissors");
    if (p1throw == "paper") return std::string("rock");
    return std::string("paper");
}
std::string win_to(const std::string p1throw){
    if (p1throw == "rock") return std::string("paper");
    if (p1throw == "paper") return std::string("scissors");
...
int main(){
    ...
    if (inputfile.is_open()){
        ...
        while (inputfile.good()){
            ...
            //X lose, Y tie, Z win
            switch (inputdata[2]){
                case 'X': p2throw = lose_to(p1throw); break;
                case 'Y': p2throw = p1throw; break;
                case 'Z': p2throw = win_to(p1throw); break;
